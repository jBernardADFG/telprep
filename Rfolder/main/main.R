...
{
  library(telprep)
  directory <- "D:/Jordy/telprep/telprep/data/raw-data/"
...
# Notes: it's getting there, but right now, a bunch of fish are being killed
# Try to impose additional structure on the emission matrix -- fish that move are alive
# msm seems to be mixing up outcomes ?
